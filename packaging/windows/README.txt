...
1. Verify the ZIP against SHA256SUMS from the same GitHub Release.
...
Audio stays on this computer. The application has no account, cloud upload or
telemetry. It does not retain audio paths, votes or sessions.

Feedback and bug reports:
https://github.com/KarmaGame33/AudioABComparator/issues

Source code and build instructions:
https://github.com/KarmaGame33/AudioABComparator
