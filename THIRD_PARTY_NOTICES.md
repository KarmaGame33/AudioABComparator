...
This inventory covers the libraries distributed in the official Windows 10/11 x64 portable build of Audio A/B Comparator 0.2.1-beta.4. The application source itself is licensed under GPL-3.0-or-later.
